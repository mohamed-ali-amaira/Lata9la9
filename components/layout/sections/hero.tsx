      ...
      <div className="grid place-items-center lg:max-w-screen-xl gap-8 mx-auto py-16 md:py-32">
        <div className="text-center space-y-8">
          ...
          <div className="max-w-screen-md mx-auto text-center">
            <h1 className="text-5xl md:text-7xl font-bold" style={{ direction: "rtl" }}>
              لا تقلق
            </h1>
            <br />
            <br />
            ...
            <h2 className="text-3xl md:text-5xl font-bold leading-tight mt-4" style={{ direction: "rtl" }}>
              استشارة وحدة تخليك{" "}
          ...
          <div className="space-y-4 md:space-y-0 md:space-x-4">
            ...
            <Button asChild variant="secondary" className="w-5/6 md:w-1/4 font-bold bg-white text-blue-600 border border-white hover:text-blue-600 transition-colors">
